...
const TopNav: React.FC<TopNavProps> = ({
  ...
  return (
    <nav className="bg-white/90 backdrop-blur-md shadow-lg sticky top-0 z-50 border-b border-emerald-100">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-2xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 max-h-96 overflow-y-auto z-50">
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1">
                        ...
                        <span className="text-xs text-gray-500 mt-1 block">{notif.type}</span>
                      </div>
                      {!notif.read && (
                        <button
                          onClick={() => onMarkAsRead(notif.id)}
                          className="text-xs bg-emerald-600 text-white px-2 py-1 rounded hover:bg-emerald-700 transition whitespace-nowrap"
                        >
                          Mark read
                        </button>
                      )}
